export const EXPERIENCE = [
  {
    ...
    Introduced clean code practices via ESLint and enforced consistent code quality standards, resulting in cleaner, more maintainable, and scalable code that is easier to review and collaborate on.
    Collaborated closely with an international team, implementing new features and ensuring seamless integration of Figma designs into code, while actively resolving bugs and enhancing feature stability.
    Migration from redux-form to react-final-form for state management, resulting in a more flexible and performant form handling solution, with simplified and more maintainable code.`,
    link: '#'
  },
  {
    id: 2,
...
export const ES_EXPERIENCE = [
  {
    ...
    Implementación de estándares de código limpio con ESLint para mantener una calidad de código consistente, obteniendo un código más mantenible, escalable y fácil de colaborar.
    Colaboración con un equipo internacional para implementar nuevas funcionalidades, integrar diseños de Figma en el código y resolver errores que mejoraron la estabilidad de las características.
    Migración de redux-form a react-final-form para el manejo de formularios, logrando una solución más flexible y de mejor rendimiento con un código más sencillo de mantener.`,
    link: '#'
  },
  {
    id: 2,
